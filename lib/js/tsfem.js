		...
		var settings = {
			...
			success: function( response ) {
				...
				if ( 'success' === response.type && response.content ) {
					status = 1;
					//* Max-height animation no longer working because of "perfect" flex.
