...
window[ 'tsfem' ] = {
	...
	initDescHover: function() {
		 ...
		 * Why would other plugins even start interfering with the description elements?
		 */
	 ...
	 * @since 1.2.0
	 *
	 * @param {(string|object|array)} value The array or string to loop.
	 * @param {string} start The start wrapper.
	 * @param {string} end The end wrapper.
	 * @return {(object|array|false)} The iterated array to string. False if input isn't array.
	 */
