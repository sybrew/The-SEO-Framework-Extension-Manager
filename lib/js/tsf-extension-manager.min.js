...
a("a#tsfem-enable-feeds").on("click",tsfem.A);a("a.tsfem-button-extension-activate, a.tsfem-button-extension-deactivate").on("click",tsfem.w);a("a.tsfem-button-disabled").on("click",tsfem.preventDefault);a(document.body).ready(tsfem.g);a(document.body).ready(tsfem.l);a(window).on("resize orientationchange",tsfem.l);a(window).on("click touchend",tsfem.u)}};jQuery(tsfem.ready);
