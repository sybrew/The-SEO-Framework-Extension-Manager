...
tsfem.w);a("a.tsfem-button-disabled").on("click",tsfem.preventDefault);a(document.body).ready(tsfem.g);a(document.body).ready(tsfem.l);a(window).on("resize orientationchange",tsfem.l);a(window).on("click",tsfem.u)}};jQuery(tsfem.ready);
