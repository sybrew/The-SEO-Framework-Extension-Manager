...
if("undefined"!==c&&0<c.length){var c=c.offset().left+c.outerWidth(),d=b.offset().left+b.outerWidth();(tsfem.rtl?d<b.width():d>c-20)&&a.css(tsfem.rtl?"right":"left",(tsfem.rtl?-(d+20):c-d-20)+"px")}}},i:function(a,b){var c=jQuery(a.target);if(!c.hasClass("tsfem-has-hover-balloon"))return!1;if(c.data("desc")){var c=c.children("div.tsfem-desc-balloon"),d=c.children("span");if(0!==d.length){var c=c.children("div"),e=c.outerWidth()/2,f=b?b:a.pageX,k=d.offset().left,g=f-k-e,h=tsfem.rtl?"right":"left";
if(1>g)d=tsfem.rtl?d.width():"0",c.css(h,d+"px");else{var l=d.outerWidth();f>k+l-e?(d=tsfem.rtl?"0":d.width(),c.css(h,d+"px")):(d=tsfem.rtl?-d.width():(l-d.width())/2-e,c.css(h,(tsfem.rtl?-(g+d):g+d)+"px"))}}}},c:function(a){if(!jQuery(a.target).hasClass("tsfem-has-hover-balloon"))return!1;jQuery(a.target).find("div.tsfem-desc-balloon").remove()},l:function(){var a=jQuery(document.body.target),b=jQuery(".tsfem-has-hover-balloon");a.closest(b).length||b.find("div.tsfem-desc-balloon").remove()},setAjaxLoader:function(a){jQuery(a).toggleClass("tsfem-loading")},
