				...
				itBuffer = setTimeout( function() {
					...
					if ( e.target.value > 50 ) {
						if ( e.target.value > 200 ) {
							...
							proceed = confirm( "You're about to load a huge number of forms. This might crash your browser. Are you sure you want to proceed?" );
						} else {
							// TODO i18n and beautify.
							proceed = confirm( "You're about to load a large number of forms. This might degredate browser performance. Are you sure you want to proceed?" );
						}
					}
