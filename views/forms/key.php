...
<form name="<?php echo esc_attr( $name ); ?>" action="<?php echo esc_url( $this->get_admin_page_url() ); ?>" method="post" id="<?php echo esc_attr( $id ) ?>" class="<?php echo esc_attr( $class_form ); ?>">
	<input id="<?php $this->field_id( 'key' ); ?>" name="<?php $this->field_name( 'key' ); ?>" type="text" size="15" value="" class="regular-text code tsfem-flex tsfem-flex-row" placeholder="<?php esc_html_e( 'License key', 'the-seo-framework-extension-manager' ); ?>">
	<input id="<?php $this->field_id( 'email' ); ?>" name="<?php $this->field_name( 'email' ); ?>" type="email" size="15" value="" class="regular-text code tsfem-flex tsfem-flex-row" placeholder="<?php esc_html_e( 'License email', 'the-seo-framework-extension-manager' ); ?>">
